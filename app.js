document.addEventListener('DOMContentLoaded', ()=>{
    ...
    // randomly select a tetr and its first rotation
    ...
    // move thr tetomino left, unless there is a blockage or is at the edge
    function moveLeft(){
        undraw()
    ...
    function moveRight(){
        ...
        if(current.some(index=>squares[currentPosition+index].classList.contains('taken'))){
            currentPosition-=1;
            // if the tetro is toching an exsiting one or reached bottom we should make them appear as if they havent moved at all 
            // they sit on top
        }
        draw()
    }
    ...
    function displayShape(){
        // remove any trace a prev tetr from entire grid
